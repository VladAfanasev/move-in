      ...
      >
        ...
        >
          <div
            data-sidebar="sidebar"
            className={cn(
              "fixed top-0 left-0 z-10 h-svh w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear",
              ...
              "group-data-[variant=floating]:m-2 group-data-[variant=floating]:h-[calc(theme(height.svh)-theme(spacing.4))] group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow",
              "group-data-[variant=inset]:m-2 group-data-[variant=inset]:ml-0 group-data-[variant=inset]:h-[calc(theme(height.svh)-theme(spacing.4))] group-data-[variant=inset]:rounded-lg group-data-[variant=inset]:border group-data-[variant=inset]:shadow",
              "group-data-[side=right]:group-data-[variant=inset]:mr-0 group-data-[side=right]:group-data-[variant=inset]:ml-2",
              className,
            )}
            {...props}
          >
            <div
              data-sidebar="sidebar"
              className="flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=inset]:rounded-lg"
            >
              {children}
            </div>
          </div>
...
const SidebarSeparator = React.forwardRef<React.ElementRef<"hr">, React.ComponentProps<"hr">>(
  ({ className, ...props }, ref) => {
    return (
      <hr
        ref={ref}
