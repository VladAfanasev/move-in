...
async function setupFresh() {
  ...
  try {
    ...
    await client.unsafe(`
      ...
      CREATE TYPE "public"."member_status" AS ENUM('pending', 'active', 'left', 'removed');
    ...
    await client.unsafe(`
      CREATE TABLE "properties" (
        ...
        "country" varchar(100) DEFAULT 'Nederland' NOT NULL,
    ...
    await client.unsafe(`
      ...
      ALTER TABLE "group_members" ADD CONSTRAINT "group_members_group_id_buying_groups_id_fk" FOREIGN KEY ("group_id") REFERENCES "public"."buying_groups"("id") ON DELETE cascade ON UPDATE no action;
      ALTER TABLE "group_members" ADD CONSTRAINT "group_members_user_id_profiles_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE cascade ON UPDATE no action;
      ALTER TABLE "group_properties" ADD CONSTRAINT "group_properties_group_id_buying_groups_id_fk" FOREIGN KEY ("group_id") REFERENCES "public"."buying_groups"("id") ON DELETE cascade ON UPDATE no action;
      ALTER TABLE "group_properties" ADD CONSTRAINT "group_properties_property_id_properties_id_fk" FOREIGN KEY ("property_id") REFERENCES "public"."properties"("id") ON DELETE cascade ON UPDATE no action;
